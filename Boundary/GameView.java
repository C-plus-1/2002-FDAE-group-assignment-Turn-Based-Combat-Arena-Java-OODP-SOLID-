...
public class GameView {
    ...
    // Lets the player pick Warrior or Wizard.
    ...
    // Lets the player pick items (e.g. 2 items, duplicates allowed).
     
    public List<Integer> promptItemSelection(List<String> itemNames,
    ...
    //Lets the player pick difficulty level.
    ...
    public void showBattlefieldStatus(List<String> names,
                                      List<String> hpTexts,
    ...
    public void showEndOfRound(List<String> names,
                               List<String> hpTexts,
                               List<String> statuses,
    ...
    // Announces backup enemies spawning.
